/* ============================================================
   AIDEN'S MOBILE DETAILING - script.js
...
(function () {
  ...
  function start() { if (reduce) return; stop(); timer = setInterval(function () { go(current + 1); }, 7000); }
...
(function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    form.querySelectorAll('[required]').forEach(function (field) {
      if (!field.value.trim()) { ok = false; field.style.borderColor = '#e0533b'; }
